...
Сохранение текста в файлы я реализовал с помощью экшенов Download и DownloadDocx, возвращающих на страницу файлы соответствующего формата, 
что выполняет условия курсовой и выводит на экран "Сохранить как" окно.
Я попытался покрыть приложение Unit тестами, и даже выловил парочку багов с их помощью, но не смог протестировать часть 
